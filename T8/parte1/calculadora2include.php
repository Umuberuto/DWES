<?php 
    ...
    //Esta la he creado porque la ruta del <a> me daba error si la llamaba desde el index.php. Si llamamos a calculadora2include.php directamente dará error. Está diseñada para ser incluida por el index.php de hecho NO hago redireccionamiento para solucionar este error para que se vea a lo que me refiero...
?>
<?php
    ...
    if ( ( !isset ($_POST['num1']) || ($_POST['num1']=="") ) || ( !isset ($_POST['num2']) || ($_POST['num2']=="") ) ) {
        ...
        switch ($_POST['op']){
            ...
            case "/":
                ...
                echo "<br><a href='./parte1/calculadora2.php'>Volver a la calculadora</a>";
                break;
        }
    }
