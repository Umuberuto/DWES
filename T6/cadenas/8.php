...
<?php
    ...
    */ 
    ...
    if( is_numeric ($prueba) ) { //IMPORTANTE: NO puedo usar if(!prueba){ porque si la palabra ESTÁ contenida pero en la posición 0 la funcion devuelve 0 en lugar de false y este 0 es interpretado como false... (El problema de los == o ===)
